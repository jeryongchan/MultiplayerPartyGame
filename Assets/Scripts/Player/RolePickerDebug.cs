...
namespace FriendSlop.Player
{
    ...
    // RoleRegistry -> spawn flow before any lobby UI exists. press F1 = Sniper, F2 = Criminal.
    // (function keys so the number row is free for the criminal pose menu, see NetworkPlayerController.)
